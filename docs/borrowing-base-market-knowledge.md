...
An interactive companion console that renders this model for portfolio risk management lives at [`lender-dashboard.html`](lender-dashboard.html) (self-contained, open in any browser).
