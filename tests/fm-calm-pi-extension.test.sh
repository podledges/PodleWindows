...
PI_WIN_SHELL="$ROOT/.pi/extensions/lib/fm-win-shell.ts"
...
test_home_resolution() {
  ...
  cp "$PI_WIN_SHELL" "$fixture/project/.pi/extensions/lib/fm-win-shell.ts"
...
test_rendering_and_session_lifecycle() {
  ...
  cp "$ROOT/.pi/extensions/lib/fm-win-shell.ts" "$fixture/lib/fm-win-shell.ts"
...
test_operational_followup_turn_e2e() {
  ...
  cp "$PI_WIN_SHELL" "$project/.pi/extensions/lib/fm-win-shell.ts"
...
test_interactive_terminal_e2e() {
  ...
  cp "$ROOT/.pi/extensions/lib/fm-win-shell.ts" "$project/.pi/extensions/lib/fm-win-shell.ts"
